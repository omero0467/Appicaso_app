...
const Form = ({handleFile,className,Type,handleInput}) => {
  return (
    <>
    ...
    <input accept='image/*' onChange={(e)=>handleFile(e)} className="block w-full text-sm text-gray-900 border-[4px] border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-300" aria-describedby="user_avatar_help" id="user_avatar" required={true} type="file"/>
