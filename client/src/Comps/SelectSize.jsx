...
const SelectSize = ({setSize, currentSize,clickHandle}) => {
...
<ul className="h-full space-y-8">
    <li value={'small'} className='relative' onClick={(e)=>clickHandle(256,e)}>
    ...
    <li value={'med'} className='relative' onClick={(e)=>clickHandle(512,e)}>
    ...
    <li value={'large'} className='relative' onClick={(e)=>clickHandle(1024,e)}>
