...
const Output = ({outputRespone ,isLoading}) => {
  return (
    <div className="glass md:ml-8 md:w-3/6 flex flex-col h-[800px]">
      ...
      <div className="objet-contain self-center max-w-[512px]">{outputRespone?<img src={outputRespone} className='object-contain' alt="output" />:<SkeletonLoader isLoading={isLoading}/>}</div>
    </div>
  );
};
